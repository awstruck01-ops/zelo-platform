  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          // Order-support threads only have 'customer' and 'driver' senders —
          // this screen is the customer's view, so a message is "mine" only
          // when it was actually sent by the customer side of the thread.
